...
const TransactionScreen = (props) => {
    ...
    return <View style={{ position: 'absolute', height: '100%', width: '100%', backgroundColor: "#fff", flexDirection: 'column', paddingHorizontal: 20 }}>
        <Text style={{
            marginTop: 40,
            marginHorizontal: 32,
            fontSize: 20,
        ...
        {isTransaction ?
            <>
                ...
                <View style={[styles.row]}>
                    ...
                    <Text style={[styles.rowData, { marginTop: 8, fontSize: 18, fontStyle: 'italic' }]}>{data}</Text>
                </View>
